    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisme_code', models.CharField(blank=True, max_length=20)),
                ('agency', models.CharField(blank=True, max_length=100)),
                ('account_number', models.CharField(max_length=50)),
                ('rib_key', models.CharField(blank=True, max_length=10)),
                ('bk_code', models.CharField(blank=True, max_length=10)),
